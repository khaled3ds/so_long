...
Custom textures: Uses XPM image files for walls, floor, player, collectibles, and exit
...
Map Loading: Reads the .ber file and parses it into a 2D array
Validation: Checks map structure, walls, entity counts, and valid characters
Pathfinding: Uses flood fill to verify all collectibles and exit are reachable
Game Loop:
